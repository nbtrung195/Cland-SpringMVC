...
<link rel="shortcut icon" type="image/ico"
	href="${pageContext.request.contextPath}/resources/admin/images/icon-180x180.png" />
...
<link href="https://fonts.googleapis.com/css?family=Lobster"
	rel="stylesheet">
<link
	href="${pageContext.request.contextPath}/resources/admin/css/style1.css"
	rel="stylesheet">
					...
					<div class="box">
						<div class="content-wrap">
							...
							<form action="${pageContext.request.contextPath}/login"
								...
								<div class="action">
									<input class="btn btn-primary signup btn-block" type="submit"
										value="ĐĂNG NHẬP">
								</div>
							</form>
						</div>
