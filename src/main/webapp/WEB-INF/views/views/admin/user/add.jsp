						...
						<form action="${pageContext.request.contextPath}/admin/user/add" method="post">
							<div class="col-sm-6">
								<div class="form-group">
								    ...
								    <br>
									<label for="name">Tên đăng nhập</label> <input type="text" name="username"
										class="form-control" placeholder="Nhập tên đăng nhập">
								</div>
								<div class="form-group">
									<form:errors path="error.password" cssStyle="color:red"></form:errors>
									<br>
									<label for="name">Tên mật khẩu</label> <input type="password" name="password"
										class="form-control" placeholder="Nhập mật khẩu">
								</div>
								<div class="form-group">
									<form:errors path="error.fullname" cssStyle="color:red"></form:errors>
									<br>
									<label for="name">Tên người dùng</label> <input type="text" name="fullname"
